...
@Component({
  selector: 'app-show-interest-card',
  templateUrl: './show-interest-card.component.html',
  styleUrls: ['./show-interest-card.component.css']
})
export class ShowInterestCardComponent {
